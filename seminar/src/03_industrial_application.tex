...
those of a domestic network (see Fig.~\ref{fig:industrial-env}). Electric motors, frequency inverters, arc-welding equipment,
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\columnwidth]{assets/slide1-1}
    \caption{Example of devices present in the industrial environment}
    \label{fig:industrial-env}
\end{figure}
...
switching transients whose amplitude is proportional to the DC bus voltage (see Fig.~\ref{fig:switching-noise}).

\begin{figure}[h]
    \centering
    \includegraphics[width=\columnwidth]{assets/slide3-3}
    \caption{Signal before and after PWM filtering. Residual switching noise is visible.}
    \label{fig:switching-noise}
\end{figure}
