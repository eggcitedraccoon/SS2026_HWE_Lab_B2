...
| **5** | Lab 5            |                    | [Oleg Kelner](https://github.com/eggcitedraccoon)  |          |  ✅ *Done*      |
### Project
| №      | Task | Short summary | Responsible person | Deadline | Status |
|:-------|:-----|:--------------|:-------------------|:---------|:-------|
| **1**  |      |               |                    |          |        |
...
| **7** | Abstract and keywords   | [Petr Lavrenov](https://github.com/DustyPetrol)                 | 14.06.2026 |  :arrows_counterclockwise: *In progress*                 |
| **8** | Conclusion              | [Oleg Kelner](https://github.com/eggcitedraccoon)                                                 | 14.06.2026 |    :arrows_counterclockwise: *In progress*               |
